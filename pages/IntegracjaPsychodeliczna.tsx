      ...
      <div className="container mx-auto px-4 py-16 lg:py-24">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="prose prose-lg text-gray-500 font-light leading-relaxed">
            ...
            <h2 className="font-serif text-3xl text-navy-900 mt-16 mb-6">Dla kogo jest ta praca?</h2>
            <p>
            ...
            <h2 className="font-serif text-3xl text-navy-900 mt-16 mb-6">Przygotowanie !</h2>
            <p>
            ...
            <h2 className="font-serif text-3xl text-navy-900 mt-16 mb-6">Integracja</h2>
            <p>
            ...
            <h2 className="font-serif text-3xl text-navy-900 mt-16 mb-6">Ważna informacja prawna !</h2>
            <p>
            ...
            <h2 className="font-serif text-2xl text-navy-900 mt-16 mb-6">Jeśli to, co przeżyłaś / przeżyłeś, wciąż w Tobie pracuje — integracja może być kolejnym, ważnym krokiem.</h2>
          </div>
