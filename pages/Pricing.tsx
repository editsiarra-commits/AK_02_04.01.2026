            ...
            <div className="flex justify-center space-x-3 mt-6 mb-4">
              {Array.from({ length: maxSlide + 1 }).map((_, idx) => (
                <button
                  ...
                  className={`h-1.5 rounded-full transition-all duration-500 ease-out cursor-pointer ${currentSlide === idx ? 'bg-coffee-400 w-10 shadow-[0_0_8px_rgba(154,115,82,0.6)]' : 'bg-warm-700 w-3 hover:bg-coffee-500 hover:w-5'
                    }`}
