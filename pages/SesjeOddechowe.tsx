    ...
    <div className="bg-surface text-gray-600">
      ...
      <section className="relative py-24 md:py-32 overflow-hidden">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
          <p className="text-coral-400 font-sans text-xs font-bold uppercase tracking-[0.3em] mb-2">
      ...
      <div className="container mx-auto px-4 py-16 lg:py-24">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="prose prose-lg text-gray-500 font-light leading-relaxed">
            ...
            <h2 className="font-serif text-3xl text-navy-900 mt-16 mb-6">Jeśli tu jesteś i czytasz ten tekst…</h2>
            ...
            <h2 className="font-serif text-3xl text-navy-900 mt-16 mb-6">Na czym polega sesja?</h2>
            <p>
            ...
            <h2 className="font-serif text-3xl text-navy-900 mt-16 mb-6">Integracja — to, co najważniejsze</h2>
            <p>
            ...
            <h2 className="font-serif text-3xl text-navy-900 mt-16 mb-6">Forma pracy</h2>
            <p>
            ...
            <h2 className="font-serif text-2xl text-navy-900 mt-16 mb-6">Ta struktura pozwala Ci nie tylko przeżyć doświadczenie, ale także je zrozumieć, zintegrować i włączyć w codzienne funkcjonowanie.</h2>
